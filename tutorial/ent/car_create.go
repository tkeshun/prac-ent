...
func (cc *CarCreate) SetCarNumber(s string) *CarCreate {
	cc.mutation.SetCarNumber(s)
	return cc
}

// SetOwnerID sets the "owner_id" field.
func (cc *CarCreate) SetOwnerID(i int) *CarCreate {
...
func (cc *CarCreate) SetUsersID(id int) *CarCreate {
	cc.mutation.SetUsersID(id)
	return cc
}

// SetUsers sets the "users" edge to the User entity.
func (cc *CarCreate) SetUsers(u *User) *CarCreate {
...
func (cc *CarCreate) check() error {
	...
	if _, ok := cc.mutation.CarNumber(); !ok {
		return &ValidationError{Name: "car_number", err: errors.New(`ent: missing required field "Car.car_number"`)}
	}
	if _, ok := cc.mutation.OwnerID(); !ok {
		return &ValidationError{Name: "owner_id", err: errors.New(`ent: missing required field "Car.owner_id"`)}
	}
	if _, ok := cc.mutation.RegisteredAt(); !ok {
	...
	if len(cc.mutation.UsersIDs()) == 0 {
		return &ValidationError{Name: "users", err: errors.New(`ent: missing required edge "Car.users"`)}
	}
	return nil
}
...
func (cc *CarCreate) createSpec() (*Car, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.CarNumber(); ok {
