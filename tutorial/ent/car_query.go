...
func (cq *CarQuery) QueryUsers() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, car.UsersTable, car.UsersColumn),
		)
...
func (cq *CarQuery) WithUsers(opts ...func(*UserQuery)) *CarQuery {
	query := (&UserClient{config: cq.config}).Query()
...
func (cq *CarQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Car, error) {
	...
	if query := cq.withUsers; query != nil {
		if err := cq.loadUsers(ctx, query, nodes, nil,
			func(n *Car, e *User) { n.Edges.Users = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CarQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Car, init func(*Car), assign func(*Car, *User)) error {
...
func (cq *CarQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := cq.ctx.Fields; len(fields) > 0 {
		...
		if cq.withUsers != nil {
			_spec.Node.AddColumnOnce(car.FieldOwnerID)
		}
	}
