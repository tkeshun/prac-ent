...
func CarNumber(v string) predicate.Car {
	return predicate.Car(sql.FieldEQ(FieldCarNumber, v))
}

// OwnerID applies equality check predicate on the "owner_id" field. It's identical to OwnerIDEQ.
func OwnerID(v int) predicate.Car {
	return predicate.Car(sql.FieldEQ(FieldOwnerID, v))
}
...
func CarNumberEQ(v string) predicate.Car {
	return predicate.Car(sql.FieldEQ(FieldCarNumber, v))
}

// CarNumberNEQ applies the NEQ predicate on the "car_number" field.
func CarNumberNEQ(v string) predicate.Car {
	return predicate.Car(sql.FieldNEQ(FieldCarNumber, v))
}

// CarNumberIn applies the In predicate on the "car_number" field.
func CarNumberIn(vs ...string) predicate.Car {
	return predicate.Car(sql.FieldIn(FieldCarNumber, vs...))
}

// CarNumberNotIn applies the NotIn predicate on the "car_number" field.
func CarNumberNotIn(vs ...string) predicate.Car {
	return predicate.Car(sql.FieldNotIn(FieldCarNumber, vs...))
}

// CarNumberGT applies the GT predicate on the "car_number" field.
func CarNumberGT(v string) predicate.Car {
	return predicate.Car(sql.FieldGT(FieldCarNumber, v))
}

// CarNumberGTE applies the GTE predicate on the "car_number" field.
func CarNumberGTE(v string) predicate.Car {
	return predicate.Car(sql.FieldGTE(FieldCarNumber, v))
}

// CarNumberLT applies the LT predicate on the "car_number" field.
func CarNumberLT(v string) predicate.Car {
	return predicate.Car(sql.FieldLT(FieldCarNumber, v))
}

// CarNumberLTE applies the LTE predicate on the "car_number" field.
func CarNumberLTE(v string) predicate.Car {
	return predicate.Car(sql.FieldLTE(FieldCarNumber, v))
}

// CarNumberContains applies the Contains predicate on the "car_number" field.
func CarNumberContains(v string) predicate.Car {
	return predicate.Car(sql.FieldContains(FieldCarNumber, v))
}

// CarNumberHasPrefix applies the HasPrefix predicate on the "car_number" field.
func CarNumberHasPrefix(v string) predicate.Car {
	return predicate.Car(sql.FieldHasPrefix(FieldCarNumber, v))
}

// CarNumberHasSuffix applies the HasSuffix predicate on the "car_number" field.
func CarNumberHasSuffix(v string) predicate.Car {
	return predicate.Car(sql.FieldHasSuffix(FieldCarNumber, v))
}

// CarNumberEqualFold applies the EqualFold predicate on the "car_number" field.
func CarNumberEqualFold(v string) predicate.Car {
	return predicate.Car(sql.FieldEqualFold(FieldCarNumber, v))
}

// CarNumberContainsFold applies the ContainsFold predicate on the "car_number" field.
func CarNumberContainsFold(v string) predicate.Car {
	return predicate.Car(sql.FieldContainsFold(FieldCarNumber, v))
}

// OwnerIDEQ applies the EQ predicate on the "owner_id" field.
func OwnerIDEQ(v int) predicate.Car {
	return predicate.Car(sql.FieldEQ(FieldOwnerID, v))
}

// OwnerIDNEQ applies the NEQ predicate on the "owner_id" field.
func OwnerIDNEQ(v int) predicate.Car {
	return predicate.Car(sql.FieldNEQ(FieldOwnerID, v))
}

// OwnerIDIn applies the In predicate on the "owner_id" field.
func OwnerIDIn(vs ...int) predicate.Car {
	return predicate.Car(sql.FieldIn(FieldOwnerID, vs...))
}

// OwnerIDNotIn applies the NotIn predicate on the "owner_id" field.
func OwnerIDNotIn(vs ...int) predicate.Car {
	return predicate.Car(sql.FieldNotIn(FieldOwnerID, vs...))
}
...
func HasUsersWith(preds ...predicate.User) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		step := newUsersStep()
