...
func (m *CarMutation) SetCarNumber(s string) {
	m.car_number = &s
}

// CarNumber returns the value of the "car_number" field in the mutation.
func (m *CarMutation) CarNumber() (r string, exists bool) {
	v := m.car_number
	if v == nil {
		return
	}
...
// OldCarNumber returns the old "car_number" field's value of the Car entity.
// If the Car object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CarMutation) OldCarNumber(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CarMutation) ResetCarNumber() {
	m.car_number = nil
}

// SetOwnerID sets the "owner_id" field.
func (m *CarMutation) SetOwnerID(i int) {
	m.users = &i
}

// OwnerID returns the value of the "owner_id" field in the mutation.
func (m *CarMutation) OwnerID() (r int, exists bool) {
	v := m.users
	if v == nil {
		return
	}
...
// OldOwnerID returns the old "owner_id" field's value of the Car entity.
// If the Car object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CarMutation) OldOwnerID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CarMutation) ResetOwnerID() {
	m.users = nil
}
...
func (m *CarMutation) SetUsersID(id int) {
	m.users = &id
}

// ClearUsers clears the "users" edge to the User entity.
func (m *CarMutation) ClearUsers() {
	m.clearedusers = true
	m.clearedFields[car.FieldOwnerID] = struct{}{}
}

// UsersCleared reports if the "users" edge to the User entity was cleared.
func (m *CarMutation) UsersCleared() bool {
	return m.clearedusers
}

// UsersID returns the "users" edge ID in the mutation.
func (m *CarMutation) UsersID() (id int, exists bool) {
	if m.users != nil {
		return *m.users, true
	}
	return
...
func (m *CarMutation) UsersIDs() (ids []int) {
...
func (m *CarMutation) Fields() []string {
	...
	if m.car_number != nil {
		fields = append(fields, car.FieldCarNumber)
	}
	if m.users != nil {
		fields = append(fields, car.FieldOwnerID)
	}
...
func (m *CarMutation) AddedEdges() []string {
	...
	if m.users != nil {
		edges = append(edges, car.EdgeUsers)
	}
	return edges
}
